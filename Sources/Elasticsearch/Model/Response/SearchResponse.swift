...
public struct SearchResponse<T: Decodable>: Decodable {
  ...
  public struct HitsContainer: Decodable {
    ...
    public struct Hit: Decodable {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.source = source
        do {
          self.highlight = try container.decode([String: [String]].self, forKey: .highlight)
        } catch {
          self.highlight = nil
        }
        do {
          self.scriptFields = try container.decode([String: [Int]].self, forKey: .scriptFields)
        } catch {
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.scrollId = try container.decodeIfPresent(String.self, forKey: .scrollId)
